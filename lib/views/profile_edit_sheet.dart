...
class _ProfileEditSheetState extends State<ProfileEditSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final viewHeight = MediaQuery.of(context).size.height * 0.75; // Set max height to 75% of screen
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Flexible(  // Make the content scrollable while maintaining the sheet size
